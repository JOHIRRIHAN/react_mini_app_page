...
function Card({data , reference}) {
  return (
    <div>
      <motion.div drag dragConstraints={reference} className='flex-shrink-0 relative w-56 h-72 rounded-[40px] bg-zinc-900/90 text-white px-8 py-10 overflow-hidden'>
        <FaFileAlt />
